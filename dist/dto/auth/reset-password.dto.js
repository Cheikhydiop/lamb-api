...
let ResetPasswordDto = (() => {
    ...
    return _a = class ResetPasswordDto {
        ...
        (() => {
            ...
            _token_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Token is required' }), (0, class_validator_1.IsString)({ message: 'Token must be a string' })];
            _newPassword_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'New password is required' }), (0, class_validator_1.MinLength)(8, { message: 'Password must be at least 8 characters long' }), (0, class_validator_1.Matches)(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&+])[A-Za-z\d@$!%*?&+]{8,}$/, {
