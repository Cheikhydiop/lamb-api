...
let VerifyEmailDto = (() => {
    ...
    return _a = class VerifyEmailDto {
        ...
        (() => {
            ...
            _code_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Le code de vérification est requis' }), (0, class_validator_1.Length)(6, 6, { message: 'Le code doit contenir exactement 6 caractères' }), (0, class_validator_1.Matches)(/^[0-9]{6}$/, {
