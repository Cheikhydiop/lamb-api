...
exports.securityHeaders = [
    ...
    helmet_1.default.dnsPrefetchControl({ allow: false }),
    helmet_1.default.frameguard({ action: 'deny' }), // Anti-clickjacking crucial pour les transactions
    helmet_1.default.ieNoOpen(),
    helmet_1.default.noSniff(),
    helmet_1.default.permittedCrossDomainPolicies({ permittedPolicies: 'none' }),
    helmet_1.default.referrerPolicy({ policy: 'strict-origin-when-cross-origin' }),
    ...
    (req, res, next) => {
        ...
        if (req.path.startsWith('/api/v1/wallet') ||
...
exports.cspViolationReport = cspViolationReport;
...
exports.websocketSecurity = websocketSecurity;
