...
const WaveServiceMock_1 = require("../services/WaveServiceMock");
 ...
 */
router.get('/checkout/:sessionId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    const { sessionId } = req.params;
    try {
        const mockService = (0, WaveServiceMock_1.getWaveServiceMock)();
        const session = yield mockService.getCheckoutSession(sessionId);
                ...
                <script>
                    ...
                    function confirmPayment() {
                        ...
                        .then(data => {
                            ...
                            const successUrl = data.success_url || '${process.env.WAVE_SUCCESS_URL}?ref=${(_a = session.client_reference) === null || _a === void 0 ? void 0 : _a.split('_')[1]}';
                            window.location.href = successUrl;
                        })
                        .catch(error => {
                            console.error('Error:', error);
                            // Rediriger vers la page d'erreur
                            const errorUrl = '${process.env.WAVE_ERROR_URL}?ref=${(_b = session.client_reference) === null || _b === void 0 ? void 0 : _b.split('_')[1]}';
                            window.location.href = errorUrl;
                        });
                    }
                    
                    function cancelPayment() {
                        const errorUrl = '${process.env.WAVE_ERROR_URL}?ref=${(_c = session.client_reference) === null || _c === void 0 ? void 0 : _c.split('_')[1]}';
                        window.location.href = errorUrl;
                    }
                </script>
            </body>
 ...
 */
router.post('/checkout/:sessionId/complete', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { sessionId } = req.params;
    try {
        const mockService = (0, WaveServiceMock_1.getWaveServiceMock)();
        ...
        yield mockService.completeCheckout(sessionId);
        res.json({
            success: true,
            success_url: `${process.env.WAVE_SUCCESS_URL}?ref=${(_a = session.client_reference) === null || _a === void 0 ? void 0 : _a.split('_')[1]}`
        });
    }
    catch (error) {
        res.status(400).json({
...
router.get('/status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const mockService = (0, WaveServiceMock_1.getWaveServiceMock)();
        const balance = yield mockService.getBalance();
